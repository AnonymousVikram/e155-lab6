...
void initSPI(int br, int cpol, int cpha) {
  ...
  // Set the output speed to be high to match the SPI clock speed for the SCK pin
  ...
  SPI1->CR2 |= SPI_CR2_FRXTH; // RXNE event is generated if the FIFO level is greater than or equal to 8-bit
  SPI1->CR2 |= SPI_CR2_SSOE; // SS output is enabled in master mode and when the SPI is enabled
